...
activity_train <- as_tibble(read.table("./train/y_train.txt", header = FALSE, col.names = "activity"))
activity_test <- as_tibble(read.table("./test/y_test.txt", header = FALSE, col.names = "activity"))
...
data_train <- read.table("./train/X_train.txt", header = FALSE, col.names = column_names)
data_test <- read.table("./test/X_test.txt", header = FALSE, col.names = column_names)
